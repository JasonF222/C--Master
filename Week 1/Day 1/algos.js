 ...
 */
 class ListNode {
  ...
  class SinglyLinkedList {
     ...
     */
        concat(addList) {
          let l1runner = this.head;
          if(this.isEmpty()) {
            this.head = addList.head;
            return this;
          }
          // iterating through our First list checking that runner.next DOES NOT equal null //
          while(l1runner.next) {
            // as we reach the end of each node of data {D|N}, we set our runner to be the next node here //
            l1runner = l1runner.next
          }
          // Once we reach the condition where runner.next EQUALS null, we set our runner pointer to the head of List 2! //
          l1runner.next = addList.head;
